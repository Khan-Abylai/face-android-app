...
public class VideoCapture {
    ...
    /**
     *
     *      Opens a ndkcamera for video capturing
     *
    ...
    /**
     *
     *     Opens a ndkcamera for video capturing with API Preference and parameters
     *
     *     The {@code params} parameter allows to specify extra parameters encoded as pairs {@code (paramId_1, paramValue_1, paramId_2, paramValue_2, ...)}.
     *     See cv::VideoCaptureProperties
     ...
     *     @return {@code true} if the ndkcamera has been successfully opened.
     *
     *     The method first calls VideoCapture::release to close the already opened file or ndkcamera.
     * @param index automatically generated
     * @param apiPreference automatically generated
