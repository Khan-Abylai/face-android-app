...
public class JavaCamera2View extends CameraBridgeViewBase {
    ...
    protected boolean initializeCamera() {
        ...
        try {
            ...
            if (camList.length == 0) {
                Log.e(LOGTAG, "Error: ndkcamera isn't detected.");
                return false;
            }
            ...
            if (mCameraID != null) {
                Log.i(LOGTAG, "Opening ndkcamera: " + mCameraID);
                manager.openCamera(mCameraID, mStateCallback, mBackgroundHandler);
            } else { // make JavaCamera2View behaves in the same way as JavaCameraView
                Log.i(LOGTAG, "Trying to open ndkcamera with the value (" + mCameraIndex + ")");
                if (mCameraIndex < camList.length) {
                    mCameraID = camList[mCameraIndex];
                    manager.openCamera(mCameraID, mStateCallback, mBackgroundHandler);
                } else {
                    // CAMERA_DISCONNECTED is used when the ndkcamera id is no longer valid
    ...
    private void createCameraPreviewSession() {
        ...
        try {
            if (null == mCameraDevice) {
                Log.e(LOGTAG, "createCameraPreviewSession: ndkcamera isn't opened");
                return;
            }
            ...
            mCameraDevice.createCaptureSession(Arrays.asList(surface),
                new CameraCaptureSession.StateCallback() {
                    ...
                    public void onConfigured(CameraCaptureSession cameraCaptureSession) {
                        ...
                        if (null == mCameraDevice) {
                            return; // ndkcamera is already closed
                        }
